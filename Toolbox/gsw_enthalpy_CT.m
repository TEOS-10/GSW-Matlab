function enthalpy_CT = gsw_enthalpy_CT(SA,CT,p)
...
%
% USAGE:
%  enthalpy_CT = gsw_enthalpy_CT(SA,CT,p), or equivalently
%     enthalpy = gsw_enthalpy(SA,CT,p)
% 
%  Note that gsw_enthalpy(SA,CT,p) is identical to gsw_enthalpy_CT(SA,CT,p).  
...
%
% OUTPUT:
%  enthalpy_CT  =  specific enthalpy                               [ J/kg ]
%
% AUTHOR: 
...
enthalpy_CT = gsw_enthalpy(SA,CT,p);

if transposed
    enthalpy_CT = enthalpy_CT.';
end
