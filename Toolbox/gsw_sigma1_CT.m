...
% gsw_sigma1_CT                    potential density anomaly with reference
%                              sea pressure of 1000 dbar (48-term equation)
%==========================================================================
% 
% USAGE:  
%  sigma1_CT = gsw_sigma1_CT(SA,CT), or equivalently
%     sigma1 = gsw_sigma1(SA,CT)
% 
%  Note that gsw_sigma1(SA,CT) is identical to gsw_sigma1_CT(SA,CT).  
