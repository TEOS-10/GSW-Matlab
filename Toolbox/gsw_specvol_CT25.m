function [specvol_CT25, in_funnel] = gsw_specvol_CT25(SA,CT,p)

% gsw_specvol_CT25                       specific volume (25-term equation)
%==========================================================================
% 
% USAGE:  
%  [specvol_CT25, in_funnel] = gsw_specvol_CT25(SA,CT,p)
%
% DESCRIPTION:
%  Calculates specific volume from Absolute Salinity, Conservative 
%  Temperature and pressure, using the computationally-efficient 25-term 
%  expression for density (McDougall et al., 2010).
%
% INPUT:
...
%
% OUTPUT:
%  specvol_CT25  =  specific volume                             [ kg m^-3 ]
...
if ~(nargin == 3)
   error('gsw_specvol_CT25:  Requires three inputs')
end %if
...
if (mt ~= ms | nt ~= ns)
    error('gsw_specvol_CT25: SA and CT must have same dimensions')
end
...
elseif (ms == mp) & (ns == np)
    ...
    error('gsw_specvol_CT25: Inputs array dimensions arguments do not agree')
end %if
...
specvol_CT25 = (adenom./anum); 

%--------------------------------------------------------------------------
% This function calculates specvol_CT25 using the computationally-efficient
...
%
%    specvol = gsw_specvol_CT(SA,CT,p)
%
%-----------------This is the end of the alternative code------------------

if transposed
    specvol_CT25 = specvol_CT25';
    in_funnel = in_funnel';
end
