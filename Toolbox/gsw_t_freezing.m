...
if (saturation_fraction < 0 | saturation_fraction > 1)
   error('gsw_t_freezing: saturation_fraction MUST be between zero and one.')
end
...
%--------------------------------------------------------------------------
% This function, gsw_t_freezing, calculates the in-situ freezing 
...
% using the GSW function gsw_CT_freezing.  The in-situ freezing temperature
...
% function, gsw_t_freezing, and ranges between -8e-4 K and 3e-4 K when 
...
% found by this exact method using the function 
% sea_ice_freezingtemperature_si in the SIA library).  
%
% c0 = 0.002519;
% 
